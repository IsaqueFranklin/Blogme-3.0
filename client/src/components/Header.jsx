...
const opções = [
  { name: 'Plano gratuito', description: 'Comece a escrever e criar sua audiência gratuitamente pelo SEO.', href: '/register', icon: ChartPieIcon },
  { name: 'Plano PRO', description: 'Torne-se PRO e tenha acesso às ferramentas de produtores de conteúdo PRO.', href: '/start', icon: CursorArrowRaysIcon },
]
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <a href="/" className="-m-1.5 p-1.5">
            ...
            <img className="h-16 w-auto" src="/BlogmeFito" alt="" />
          </a>
        </div>
